...
%need to subtract a percentage of dEdW from W and .. of dEdV from V (look
%at algorithm rubikscode) maybe add!
%do while loop to get different random sample
%check how much c is each time - it should decrease
